...
def MakeI3Geometry(simfile, narms, dr, maxR):
    ...
    with open(inpFile) as f:
        ...
        print("Found file with zen: {}, azi: {}, obslev: {}".format(zenith / I3Units.degree, azimuth / I3Units.degree, obslev / I3Units.m))
    ...
    radii = np.linspace(dr, maxR, int((maxR - dr) / dr))
    ...
    for ir, r in enumerate(radii):
        for iang, angle in enumerate(arms):
            ...
            posInIC += particle.dir * posInIC.z / np.cos(particle.dir.zenith)
            posInIC.z = obslev
